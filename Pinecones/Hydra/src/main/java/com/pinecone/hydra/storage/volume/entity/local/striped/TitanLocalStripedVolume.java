...
public class TitanLocalStripedVolume extends ArchLogicVolume implements LocalStripedVolume {
    ...
    public StorageIOResponse channelExport(StorageIORequest storageIORequest, FileChannel channel) throws IOException, SQLException {
        TitanStripedChannelExportEntity64 titanStripedChannelExportEntity64 = new TitanStripedChannelExportEntity64( this.volumeManager, storageIORequest, channel, this );
