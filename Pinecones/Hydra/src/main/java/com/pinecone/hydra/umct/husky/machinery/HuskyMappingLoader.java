...
public class HuskyMappingLoader extends ArchMultiScopeLoader implements MultiMappingLoader {
    ...
    protected HuskyMappingLoader( ClassScope classScope, ClassLoader classLoader, ClassPool classPool, PMCTMarshal marshal ) {
        ...
        this.mClassScanner.addExcludeFilter( new ExcludeHuskyMappingFilters( this.mClassInspector, this.mPMCTMarshal ) );
    }

    protected HuskyMappingLoader( ClassScope classScope, ClassLoader classLoader, PMCTMarshal marshal ) {
        this( classScope, classLoader, ClassPool.getDefault(), marshal );
    }

    public HuskyMappingLoader( DynamicFactory factory, PMCTMarshal marshal ) {
